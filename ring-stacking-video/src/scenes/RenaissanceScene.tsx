...
const line1Words: CaptionWord[] = [
  {text: 'พอเข้าสู่', startFrame: 5},
  {text: 'ยุคเรเนสซองส์', startFrame: 14, highlight: true},
  {text: 'เทรนด์นี้', startFrame: 26},
  {text: 'ยิ่งฮาร์ดคอร์', startFrame: 34, highlight: true},
  {text: 'ขึ้น!', startFrame: 44},
];

const line2Words: CaptionWord[] = [
  {text: 'พวกผู้ดี', startFrame: 120},
  {text: 'จะใส่', startFrame: 128},
  {text: 'ถุงมือ', startFrame: 134},
  {text: 'ผ้าไหม', startFrame: 140, highlight: true},
  {text: 'ราคาแพง', startFrame: 148},
  {text: 'แต่พวกเขา', startFrame: 165},
  {text: "จะ'ตัดปลาย", startFrame: 173, highlight: true},
  {text: "ถุงมือออก'", startFrame: 182, highlight: true},
  {text: 'เพื่อเปิดทาง', startFrame: 210},
  {text: 'ให้แหวนอัญมณี', startFrame: 222, highlight: true},
  {text: 'ที่เลเยอร์กัน', startFrame: 234},
  {text: 'เป็นชั้นๆ', startFrame: 244, highlight: true},
  {text: 'ได้ส่องแสง', startFrame: 256},
  {text: 'กระแทกตาคนมอง!', startFrame: 268, highlight: true},
];
...
const NoblewomanSVG: React.FC = () => (
  ...
  >
    ...
    <path
      d="M200 480 Q100 510 70 700 Q100 690 120 720 Q140 690 200 480Z"
      fill="#8B1530"
      opacity="0.5"
    />
    <path
      d="M200 480 Q300 510 330 700 Q300 690 280 720 Q260 690 200 480Z"
      fill="#8B1530"
      opacity="0.5"
    />
    {/* Ruffle detail lines */}
    ...
    {/* Left sleeve (extended arm) */}
    <path
      d="M140 290 Q80 270 30 320 Q10 340 20 360 Q30 380 55 365 Q100 330 145 340"
      fill="#2d0a5e"
    />
    <path d="M140 290 Q95 285 55 310" fill="none" stroke="#C4A017" strokeWidth="3" />
    {/* Right sleeve */}
    <path
      d="M260 290 Q320 270 350 310 Q368 330 355 360 L330 350 Q300 320 265 340"
      fill="#2d0a5e"
    />
    ...
    {/* Extended left arm gloved hand */}
    <path
      d="M20 355 Q5 350 0 340 Q-5 328 10 322 Q25 316 35 328 L55 365Z"
      fill="#F5F0E8"
      opacity="0.95"
    />
    {/* Glove finger shapes */}
...
const RING_FRAMES = [182, 196, 210, 224, 238];
...
export const RenaissanceScene: React.FC = () => {
  ...
  const scissorProgress = interpolate(frame, [130, 165], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
  const scissorOpacity = interpolate(frame, [120, 130, 175, 195], [0, 1, 1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
  ...
  return (
    ...
    >
      ...
      {/* Jeweled rings on cut glove fingertips */}
      {RING_FRAMES.map((startF, i) => {
        ...
        return (
          <div
            key={i}
            style={{transform: `scale(${sc})`, transformOrigin: `${pos.x}px ${pos.y}px`}}
          >
            <Ring x={pos.x} y={pos.y} rx={rx} ry={11} color="#C4A017" gemColor={RING_GEMS[i]} />
          </div>
        );
      })}

      {/* Sparkle particles on ring reveal */}
      {frame >= 182 && (
        <Particles startFrame={182} cx={160} cy={450} count={15} radius={120} color="#FFE566" />
      )}
      {frame >= 210 && (
        <Particles startFrame={210} cx={175} cy={445} count={12} radius={100} color="#9C27B0" />
      )}

      {/* SFX pops */}
      <SfxPop text="ฉึก! ✂️" x={200} y={550} startFrame={150} color="#4DD0E1" size={85} />
      <SfxPop text="✨ SPARKLE!" x={250} y={480} startFrame={195} color="#FFE566" size={75} rotation={5} />
      ...
      {/* Captions */}
      <WordCaption words={line1Words} endFrame={100} y={1440} />
      <WordCaption words={line2Words} endFrame={440} y={1440} />
    </AbsoluteFill>
  );
};
